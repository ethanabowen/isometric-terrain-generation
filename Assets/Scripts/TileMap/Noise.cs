...
{
    public static float[] GenerateNoiseMapOneDimension(int width, int height, int seed, float scale, int octaves, float persistence,
    ...
    public static float[,] GenerateNoiseMapMatrix(int mapWidth, int mapHeight, int seed, float scale, int octaves, float persistence,
	    float lacunarity, Vector2 offset) {
