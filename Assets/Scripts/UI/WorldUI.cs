...
namespace UI {
    public class WorldUI : MonoBehaviour {
        ...
        private void ReloadUI() {
            ...
            worldMap.setProcessWorldEvents(false);
            worldMap.m_HeightSettings.autoUpdate = false;
            //Change Handlers removed to prevent the slider value updates cause the World to Generate
            RemoveChangeHandlers();
            InitUIValues();
            InitChangeHandlers();
            worldMap.setProcessWorldEvents(true);
            worldMap.m_HeightSettings.autoUpdate = true;
        }
        /// <summary>
